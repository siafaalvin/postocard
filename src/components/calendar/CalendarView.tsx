...
export function CalendarView({ profileUser, viewerId, isOwn, selectedDay }: Props) {
  ...
  async function selectDay(day: number) {
    ...
    router.push(`/${profileUser.username}/calendar?day=${dateStr}`, { scroll: false });
  ...
  return (
    <div>
      <h1 className="mb-4 text-xl font-bold">{profileUser.displayName}&apos;s calendar</h1>
